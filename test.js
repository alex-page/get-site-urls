...
test("Clean URL test", (t) => {
  t.is(cleanUrl("https://alexpage.dev/"), "https://alexpage.dev");
  t.is(cleanUrl("https://alexpage.dev"), "https://alexpage.dev");
  t.is(cleanUrl("alexpage.dev/"), "https://alexpage.dev");
  t.is(cleanUrl("alexpage.dev"), "https://alexpage.dev");
  t.is(cleanUrl("https://alexpage.dev/#abc"), "https://alexpage.dev");
  t.is(
    cleanUrl("https://alexpage.dev/withslash/"),
    "https://alexpage.dev/withslash"
  );
  t.is(
    cleanUrl("https://alexpage.dev/home/../about"),
    "https://alexpage.dev/about"
  );
  t.is(cleanUrl("https://alexpage.dev/?a=abc?b=123"), "https://alexpage.dev");
  t.is(cleanUrl("asiodjoais"), "http://asiodjoais");
  t.is(
    cleanUrl("https://ds:ds@designsystem.apps.y.cld.gov.au/"),
    "https://designsystem.apps.y.cld.gov.au"
  );
});
